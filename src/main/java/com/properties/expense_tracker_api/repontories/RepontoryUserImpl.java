...
@Repository
public class RepontoryUserImpl implements RepontoryUser{
    private static String SQL_CREATE = "insert into et_users(user_id,first_name,last_name,email,password) values (nextval('et_users_seq'),?,?,?,?);";
